...
// AnalysisInput represents the input for AI analysis
...
// AnalysisOutput is an alias for AnalysisResult
type AnalysisOutput = analyzer.AnalysisResult

// ComprehensiveAnalysis is an alias for AnalysisResult
type ComprehensiveAnalysis = analyzer.AnalysisResult
